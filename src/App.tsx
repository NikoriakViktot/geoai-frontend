...
export default function App() {
    // невелика fallback-навігація, якщо сторінка не знайдена
    const NotFound = () => (
        <div style={{ padding: 20 }}>
            <h2>Not found</h2>
            <p>
                Go to <Link to="/">Home</Link> or <Link to="/flood_scenarios/">Flood Scenarios</Link>
            </p>
        </div>
    );
    ...
    return (
        <BrowserRouter>
            <Routes>
                ...
                <Route path="/flood_scenarios" element={<Dashboard />} />
